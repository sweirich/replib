...
(* Rename the binders in the pattern using the list of variables. Fails if 
   there are not enough names given.*)
Parameter rename : list var -> term -> option term.
